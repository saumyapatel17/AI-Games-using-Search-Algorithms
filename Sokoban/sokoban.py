...
Original file is located at
    https://colab.research.google.com/drive/1vbN6HREowteskNY_kJokeN2mECRDAlNN
"""
...
# class for defining State spaces for search routines
class StateSpace:
    n = 0
...
# constants indicate if we use the gval, the hval or the sum of gval and hval in the comparison
_SUM_HG = 0
_H = 1
_G = 2
_C = 3
...
# Object of this class form the nodes of the search space.  Each node consists of a search space object
class sNode:
    n = 0
    lt_type = _SUM_HG
...
# Open objects hold the search frontier, the set of unexpanded nodes
class Open:
